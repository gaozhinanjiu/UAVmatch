...
cfg.MODEL.TRANSFORMER.NUM_FEATURE_LEVELS=3
cfg.MODEL.TRANSFORMER.DEC_N_POINTS=4
cfg.MODEL.TRANSFORMER.ENC_N_POINTS=4
cfg.MODEL.TRANSFORMER.TWO_STAGE=False
cfg.MODEL.TRANSFORMER.TWO_STAGE_NUM_PROPOSALS=6
...
cfg.DATA.SAMPLER_MODE='rand_RGBT'
# DATA.TRAIN
...
cfg.DATA.SEARCH.SIZE = 480
cfg.DATA.SEARCH.FACTOR = 5.0
cfg.DATA.SEARCH.CENTER_JITTER = 4.5
cfg.DATA.SEARCH.SCALE_JITTER = 0.5
# DATA.TEMPLATE
cfg.DATA.TEMPLATE = edict()
cfg.DATA.TEMPLATE.SIZE = 480
cfg.DATA.TEMPLATE.FACTOR = 2.0
cfg.DATA.TEMPLATE.CENTER_JITTER = 0
cfg.DATA.TEMPLATE.SCALE_JITTER = 0
# DATA.AFF
cfg.DATA.AFF = edict()
cfg.DATA.AFF.type='aff'
cfg.DATA.AFF.random_t_hom = 0.1
cfg.DATA.AFF.rot_angle = 480
cfg.DATA.AFF.sh_angle = 2.0
cfg.DATA.AFF.lambda_1 = 0
cfg.DATA.AFF.lambda_2 = 0
cfg.DATA.AFF.tx=10
cfg.DATA.AFF.ty=10
# TEST
cfg.TEST = edict()
