...
class DroneVehicleDataset(BaseImageDataset):
    ...
    def get_sequence_list(self, min_area=None):
        ...
        if min_area is not None:
            print('error!')
            # image_list = [a for a in image_list if self.coco_set.anns[a]['area'] > min_area]
        return [['DroneVehicle001',image_list1,'DroneVehicle',num_p],
                ['DroneVehicle002',image_list2,'DroneVehicle',num_p],
                ['DroneVehicle003',image_list3,'DroneVehicle',num_p],
                ['DroneVehicle004',image_list4,'DroneVehicle',num_p]]
    '''
