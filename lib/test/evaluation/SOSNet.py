...
import torch
from lib.models.SOSNet.sosnet_model import SOSNet32x32
from lib.models.SOSNet.tfeat_utils import describe_opencv
def Splice(img1, img2):
    try:
        torch.no_grad()
        sosnet32 = SOSNet32x32()
        sosnet32.load_state_dict(torch.load('/home/ldd/Desktop/Projects/Stark-loftr/lib/models/SOSNet/sosnet-32x32-notredame.pth'))
        sosnet32.cuda().eval()
        ...
        desc_tfeat1 = describe_opencv(sosnet32, img1, kp1, patch_size=32, mag_factor=3)
        desc_tfeat2 = describe_opencv(sosnet32, img2, kp2, patch_size=32, mag_factor=3)
    ...
    # 得到良好匹配对的坐标对
        ...
        ransac_max_iter = 1000  # RANSAC最大迭代次数
