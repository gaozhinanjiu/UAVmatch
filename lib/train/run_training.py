...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    settings.cfg_file = os.path.join(prj_dir, 'experiments/%s/%s.yaml' % (script_name, config_name))   #config 文件
    if distill:
...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/ldd/Desktop/Projects/Stark-loftr/workspace',help='the directory to save checkpoints and logs')
