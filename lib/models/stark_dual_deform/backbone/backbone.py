...
from lib.models.stark_dual_deform.backbone import resnet as resnet_module
...
class BackboneBase(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, train_backbone: bool, num_channels: int, return_interm_layers: bool,
        ...
        if return_interm_layers:
            if net_type == "resnet":
                return_layers = {"layer2": "0", "layer3": "1", "layer4": "2"}  # stride = 4, 8, 16
                self.strides = [8, 16, 32]
                self.num_strides_channels = [512, 1024, 2048]
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        if "resnet" in name:
            ...
            num_channels = 256 if name in ('resnet18', 'resnet34') else 2048
            net_type = "resnet"
        elif "RepVGG" in name:
...
class Joiner(nn.Sequential):
    def __init__(self, backbone, position_embedding):
        ...
        self.num_strides_channels = backbone.num_strides_channels
