...
def build_fusion(d_model, dim_feedforward,
                 dropout,normalize_before=False,
                 return_intermediate_dec=False,
                 activation="relu",nhead=8,num_decoder_layers=1,divide_norm=False):
    ...
    if num_decoder_layers == 0:
        ...
        fusion_model = TransformerDecoder(decoder_layer, num_decoder_layers, decoder_norm,
