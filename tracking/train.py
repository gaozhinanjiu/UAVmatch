...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/ldd/Desktop/Projects/Stark-loftr/workspace',help='root directory to save checkpoints, logs, and tensorboard')
...
def main():
    ...
    if args.mode == "single":
        ...
        train_cmd = "python -m torch.distributed.launch --nproc_per_node %d /home/ldd/Desktop/Projects/Stark-loftr/lib/train/run_training.py " \
